 ...
 * {@linkplain org.springframework.security.core.context.SecurityContext}
 * and the session. This controller will also log users out of Auth0 by calling
 * the
 * <a href=
 * "https://auth0.com/docs/api/authentication?javascript&_ga=2.220855071.683371550.1592511441-1771410918.1592511441#logout">Auth0
 * logout endpoint</a>.
 */
@Controller
public class LogoutHandler extends SecurityContextLogoutHandler {
    ...
    /**
     * Create a new instance with a {@code ClientRegistrationRepository}, so that we
     * can look up information about the
     * configured provider to call the Auth0 logout endpoint. Called by the Spring
     * framework.
     *
     * @param clientRegistrationRepository the {@code ClientRegistrationRepository}
    ...
    /**
     * Delegates to {@linkplain SecurityContextLogoutHandler} to log the user out of
     * the application, and then logs
     ...
     * ID and issuer for building the
